...
def analysis(input, target, pretrained=False, aug_types=["original"]):
    ...
    # pretrained 모델 설정
    if pretrained:
        args.model_weights = 'checkpoints/250307_pap1024_weight_1499_bs4/model_0017499.pth'
        args.pretrained_model = 'checkpoints/patchseg/model_0001499.pth'
        args.pretrained_weight = 0.5
        args.pretrained_mode = 'weight'
    else:
        args.model_weights = 'checkpoints/250307_pap1024_bs4/model_0017499.pth'
    ...
    if pretrained:
        ...
        if 'SR' in input or 'HR' in input:
            ...
            args.crop_size = 128
        args.model_weights = 'checkpoints/patchseg/model_0001499.pth'
