...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--isX', default=True)
        parser.add_argument('--salA', type=int, default=170)
        parser.add_argument('--salB', type=int, default=170)
        # basic parameters
        parser.add_argument('--dataroot', default='placeholder', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='virtualstaining', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', choices=['resnet_9blocks', 'deep_resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
        ...
        parser.add_argument('--A_minmax', nargs='+', default = [0, 200])
    ...
    def parse(self, cmd_line=None):
        ...
        if cmd_line is None:
            cmd_line = []  # No command line passed, use default args
        ...
        # set minmax
        if opt.A_minmax != None:
            opt.A_minmax = [int(m) for m in opt.A_minmax]
